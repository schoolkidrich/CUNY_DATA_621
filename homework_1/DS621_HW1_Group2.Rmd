...
knitr::opts_chunk$set(echo = FALSE, warning=FALSE, message=FALSE) #sets global options for chunks when *knit*
...
```{r updatedDataSummary, echo=FALSE, message=FALSE, warning=FALSE, inlcude=FALSE}
