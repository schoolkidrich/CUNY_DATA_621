...
```{r load_training_data, message=FALSE, echo=FALSE}
...
```{r renameColumns, echo=FALSE, message=FALSE}
...
```{r summaryData, warning=FALSE, message=FALSE}
# Summarize the data.
summary(mb_training)
```
...
```{r testDataSummary, message=FALSE}
